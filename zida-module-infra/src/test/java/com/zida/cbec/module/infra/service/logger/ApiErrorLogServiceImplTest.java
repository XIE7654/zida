...
import com.zida.cbec.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.zida.cbec.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.zida.cbec.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.zida.cbec.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.zida.cbec.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.zida.cbec.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.zida.cbec.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("zida-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("zida-test");
