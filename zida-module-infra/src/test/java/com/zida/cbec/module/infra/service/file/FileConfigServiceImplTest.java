package com.zida.cbec.module.infra.service.file;
...
import com.zida.cbec.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.zida.cbec.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.zida.cbec.module.infra.dal.dataobject.file.FileConfigDO;
import com.zida.cbec.module.infra.dal.mysql.file.FileConfigMapper;
import com.zida.cbec.module.infra.framework.file.core.client.FileClient;
import com.zida.cbec.module.infra.framework.file.core.client.FileClientConfig;
import com.zida.cbec.module.infra.framework.file.core.client.FileClientFactory;
import com.zida.cbec.module.infra.framework.file.core.client.local.LocalFileClient;
import com.zida.cbec.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.zida.cbec.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.zida.cbec.framework.test.core.util.RandomUtils.randomLongId;
import static com.zida.cbec.framework.test.core.util.RandomUtils.randomPojo;
import static com.zida.cbec.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.zida.cbec.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("自达源码")
