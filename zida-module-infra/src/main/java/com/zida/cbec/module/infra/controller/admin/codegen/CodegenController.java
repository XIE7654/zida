package com.zida.cbec.module.infra.controller.admin.codegen;
...
import com.zida.cbec.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.zida.cbec.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.zida.cbec.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.zida.cbec.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.zida.cbec.module.infra.convert.codegen.CodegenConvert;
...
import com.zida.cbec.module.infra.service.codegen.CodegenService;
...
import static com.zida.cbec.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.zida.cbec.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "zida"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "自达")
    })
