package com.zida.cbec.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.zida.cbec.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.zida.cbec.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "自达源码，牛逼！")
    @ExcelProperty("结果提示")
