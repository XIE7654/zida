...
import com.zida.cbec.framework.common.util.cache.CacheUtils;
import com.zida.cbec.framework.common.util.http.HttpUtils;
import com.zida.cbec.framework.common.util.object.BeanUtils;
import com.zida.cbec.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.zida.cbec.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.zida.cbec.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.zida.cbec.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.zida.cbec.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.zida.cbec.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.zida.cbec.module.system.dal.dataobject.social.SocialClientDO;
import com.zida.cbec.module.system.dal.mysql.social.SocialClientMapper;
import com.zida.cbec.module.system.dal.redis.RedisKeyConstants;
import com.zida.cbec.module.system.enums.social.SocialTypeEnum;
import com.zida.cbec.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.zida.cbec.framework.common.util.collection.MapUtils.findAndThen;
import static com.zida.cbec.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.zida.cbec.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${zida.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${zida.wxa-subscribe-message.miniprogram-state:formal}")
