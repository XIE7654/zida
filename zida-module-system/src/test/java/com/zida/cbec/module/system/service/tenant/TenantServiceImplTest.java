...
import com.zida.cbec.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.zida.cbec.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.zida.cbec.module.system.dal.dataobject.permission.MenuDO;
import com.zida.cbec.module.system.dal.dataobject.permission.RoleDO;
import com.zida.cbec.module.system.dal.dataobject.tenant.TenantDO;
import com.zida.cbec.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.zida.cbec.module.system.dal.mysql.tenant.TenantMapper;
import com.zida.cbec.module.system.enums.permission.RoleCodeEnum;
import com.zida.cbec.module.system.enums.permission.RoleTypeEnum;
import com.zida.cbec.module.system.service.permission.MenuService;
import com.zida.cbec.module.system.service.permission.PermissionService;
import com.zida.cbec.module.system.service.permission.RoleService;
import com.zida.cbec.module.system.service.tenant.handler.TenantInfoHandler;
import com.zida.cbec.module.system.service.tenant.handler.TenantMenuHandler;
import com.zida.cbec.module.system.service.user.AdminUserService;
...
import static com.zida.cbec.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("自达", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("自达"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("自达");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
