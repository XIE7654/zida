package com.zida.cbec.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.zida.cbec.framework.common.enums.CommonStatusEnum;
import com.zida.cbec.framework.common.exception.ServiceException;
import com.zida.cbec.framework.common.pojo.PageResult;
import com.zida.cbec.framework.common.util.collection.ArrayUtils;
import com.zida.cbec.framework.common.util.collection.CollectionUtils;
import com.zida.cbec.framework.test.core.ut.BaseDbUnitTest;
import com.zida.cbec.module.infra.api.config.ConfigApi;
import com.zida.cbec.module.infra.api.file.FileApi;
import com.zida.cbec.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.zida.cbec.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.zida.cbec.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.zida.cbec.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.zida.cbec.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.zida.cbec.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.zida.cbec.module.system.dal.dataobject.dept.DeptDO;
import com.zida.cbec.module.system.dal.dataobject.dept.PostDO;
import com.zida.cbec.module.system.dal.dataobject.dept.UserPostDO;
import com.zida.cbec.module.system.dal.dataobject.tenant.TenantDO;
import com.zida.cbec.module.system.dal.dataobject.user.AdminUserDO;
import com.zida.cbec.module.system.dal.mysql.dept.UserPostMapper;
import com.zida.cbec.module.system.dal.mysql.user.AdminUserMapper;
import com.zida.cbec.module.system.enums.common.SexEnum;
import com.zida.cbec.module.system.service.dept.DeptService;
import com.zida.cbec.module.system.service.dept.PostService;
import com.zida.cbec.module.system.service.permission.PermissionService;
import com.zida.cbec.module.system.service.tenant.TenantService;
...
import static com.zida.cbec.framework.common.util.collection.SetUtils.asSet;
import static com.zida.cbec.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.zida.cbec.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.zida.cbec.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.zida.cbec.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.zida.cbec.framework.test.core.util.AssertUtils.assertServiceException;
import static com.zida.cbec.framework.test.core.util.RandomUtils.*;
import static com.zida.cbec.module.system.enums.ErrorCodeConstants.*;
import static com.zida.cbec.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("zidayuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zidayuanma");
        ...
        assertEquals("zidayuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zidayuanma"))).thenReturn("java");
