package com.zida.cbec.module.system.service.mail;
...
import com.zida.cbec.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.zida.cbec.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.zida.cbec.module.system.dal.dataobject.mail.MailTemplateDO;
import com.zida.cbec.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.zida.cbec.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("自达")));
        // 测试 code 不匹配
