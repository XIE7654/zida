 ...
 *      1）Spring Async：
 *          {@link com.zida.cbec.framework.quartz.config.ZidaAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ZidaSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.zida.cbec.framework.tenant;
