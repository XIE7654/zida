package com.zida.cbec.framework.tracer.config;

import com.zida.cbec.framework.common.enums.WebFilterOrderEnum;
import com.zida.cbec.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "zida.tracer", value = "enable", matchIfMissing = true)
public class ZidaTracerAutoConfiguration {
