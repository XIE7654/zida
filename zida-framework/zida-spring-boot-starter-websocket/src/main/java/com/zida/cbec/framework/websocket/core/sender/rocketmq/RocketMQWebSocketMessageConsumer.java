package com.zida.cbec.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${zida.websocket.sender-rocketmq.topic}",
        consumerGroup = "${zida.websocket.sender-rocketmq.consumer-group}",
