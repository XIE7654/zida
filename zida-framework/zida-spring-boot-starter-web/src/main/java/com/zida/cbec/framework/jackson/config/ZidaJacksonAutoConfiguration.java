package com.zida.cbec.framework.jackson.config;

import com.zida.cbec.framework.common.util.json.JsonUtils;
import com.zida.cbec.framework.common.util.json.databind.NumberSerializer;
import com.zida.cbec.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.zida.cbec.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class ZidaJacksonAutoConfiguration {
