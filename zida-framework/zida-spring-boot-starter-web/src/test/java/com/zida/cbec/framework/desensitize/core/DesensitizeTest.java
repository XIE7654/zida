package com.zida.cbec.framework.desensitize.core;
...
import com.zida.cbec.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.zida.cbec.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.zida.cbec.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("自达源码");
        ...
        desensitizeDemo.setRegex("你好，我是自达源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("自达源码");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "自达源码", replacer = "*")
