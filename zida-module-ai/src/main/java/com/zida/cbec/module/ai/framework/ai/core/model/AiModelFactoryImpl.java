package com.zida.cbec.module.ai.framework.ai.core.model;
...
import com.zida.cbec.framework.common.util.spring.SpringUtils;
import com.zida.cbec.module.ai.enums.model.AiPlatformEnum;
import com.zida.cbec.module.ai.framework.ai.config.AiAutoConfiguration;
import com.zida.cbec.module.ai.framework.ai.config.ZidaAiProperties;
...
import com.zida.cbec.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.zida.cbec.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ZidaAiProperties.Midjourney properties = SpringUtil.getBean(ZidaAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ZidaAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ZidaAiProperties.DouBao properties = new ZidaAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ZidaAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ZidaAiProperties.HunYuan properties = new ZidaAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ZidaAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ZidaAiProperties.SiliconFlow properties = new ZidaAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ZidaAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        ZidaAiProperties.XingHuo properties = new ZidaAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ZidaAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ZidaAiProperties.BaiChuan properties = new ZidaAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(ZidaAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        ZidaAiProperties.Gemini properties = SpringUtil.getBean(ZidaAiProperties.class)
