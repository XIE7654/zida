package com.zida.cbec.module.ai.service.chat;
...
import com.zida.cbec.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.zida.cbec.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.zida.cbec.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.zida.cbec.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.zida.cbec.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.zida.cbec.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.zida.cbec.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.zida.cbec.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.zida.cbec.module.ai.dal.dataobject.model.AiModelDO;
import com.zida.cbec.module.ai.dal.dataobject.model.AiToolDO;
import com.zida.cbec.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.zida.cbec.module.ai.enums.ErrorCodeConstants;
import com.zida.cbec.module.ai.enums.model.AiPlatformEnum;
import com.zida.cbec.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.zida.cbec.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.zida.cbec.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.zida.cbec.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.zida.cbec.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.zida.cbec.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.zida.cbec.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.zida.cbec.module.ai.service.model.AiChatRoleService;
import com.zida.cbec.module.ai.service.model.AiModelService;
import com.zida.cbec.module.ai.service.model.AiToolService;
import com.zida.cbec.module.ai.util.AiUtils;
import com.zida.cbec.module.ai.util.FileTypeUtils;
...
import static com.zida.cbec.framework.common.pojo.CommonResult.error;
...
import static com.zida.cbec.framework.common.util.collection.CollectionUtils.convertSet;
import static com.zida.cbec.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.zida.cbec.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 zida.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 zida.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
