...
public interface TemuStoreMapper extends BaseMapperX<TemuStoreDO> {
    ...
    default PageResult<TemuStoreDO> selectPage(TemuStorePageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<TemuStoreDO>()
                .eqIfPresent(TemuStoreDO::getShopType, reqVO.getShopType())
                .likeIfPresent(TemuStoreDO::getShopName, reqVO.getShopName())
                ...
                .eqIfPresent(TemuStoreDO::getShopCurrency, reqVO.getShopCurrency())
                .eqIfPresent(TemuStoreDO::getShopSite, reqVO.getShopSite())
