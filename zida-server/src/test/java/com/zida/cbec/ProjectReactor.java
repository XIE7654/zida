...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.zida.cbec";
    private static final String ARTIFACT_ID = "zida";
    private static final String PACKAGE_NAME = "com.zida.cbec";
    private static final String TITLE = "自达管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.zida.cbec";
        String artifactIdNew = "zida";
        String packageNameNew = "com.zida.cbec";
        String titleNew = "自达管理系统";
