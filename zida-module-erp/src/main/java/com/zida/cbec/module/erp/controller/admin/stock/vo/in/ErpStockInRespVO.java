package com.zida.cbec.module.erp.controller.admin.stock.vo.in;
...
import static com.zida.cbec.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "自达")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "自达")
    private String creator;
    @Schema(description = "创建人名称", example = "自达")
